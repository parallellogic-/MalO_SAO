...
import _thread,malo
from animation.animation_fade import AnimationFade
...
try:
    ...
    print("\nThonny stopped the execution! Cleaning up...")
    
    # Signal Core 1 to stop running its rendering loop
    malo.set_halt_core1(True)
    time.sleep(0.1)
