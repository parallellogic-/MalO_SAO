...
#undef MODULE_DEF_LVGL
#define MODULE_DEF_LVGL { MP_ROM_QSTR(MP_QSTR_lvgl), MP_ROM_PTR(&mp_module_lvgl) },

extern const struct _mp_obj_module_t malo_user_module;
#undef MODULE_DEF_MALO
#define MODULE_DEF_MALO { MP_ROM_QSTR(MP_QSTR_malo), MP_ROM_PTR(&malo_user_module) },
