...
// Define the PIO assembly program structure manually for the Arduino compiler
static const uint16_t set_pins_instructions[] = {
...
static const struct pio_program set_pins_program = {
    .instructions = set_pins_instructions,
    .length = 3,
    .origin = -1,
};
