...
void loop() {
    ...
    uint8_t mid=0x05;
    uint8_t height=8*2;
    display.fillRect(0, 0, display.width(), display.height(),  mid);
    display.fillRect(32, display.height()*0.5, height, 0.5*display.height()*sin(millis()*3.1415/1000),  dark);
    display.fillRect(32+16, display.height()*0.5, height, 0.5*display.height()*sin(millis()*3.1415/1000),  dark);
    display.fillRect(32+32, display.height()*0.5, height, 0.5*display.height()*sin(millis()*3.1415/1000),  dark);
    display.fillRect(32+32+16, display.height()*0.5, height, 0.5*display.height()*sin(millis()*3.1415/1000),  dark);
    display.fillRect(64+16, display.height()*0.5, 32, 0.5*display.height()*sin(millis()*3.1415/1000+3.1415/4),  0x0F);
    display.display();
    delay(16);
