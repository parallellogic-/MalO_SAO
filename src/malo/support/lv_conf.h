...
/*#define LV_USE_ANIMATION        0        // Disables screen/widget fade animations
#define LV_USE_SHADOW           0        // Eliminates shadow structural memory
#define LV_USE_OBJ_PROPERTY     0        // Disables the dynamic property get/set string tables
#define LV_USE_FREETYPE         0        // Ensure heavy external font engines are off
#define LV_IMAGE_CACHE_DEF_SIZE 0        // Disable image cache
#define LV_DRAW_SW_LAYER_POOL_SIZE 0     // Disable offscreen complex layer blending */
 ...
 */
#define LV_USE_STDLIB_MALLOC    LV_STDLIB_BUILTIN//LV_STDLIB_CLIB//LV_STDLIB_BUILTIN
 ...
 * - LV_STDLIB_CUSTOM:      Implement the functions externally
 */
#define LV_USE_STDLIB_STRING    LV_STDLIB_BUILTIN//LV_STDLIB_CLIB//LV_STDLIB_BUILTIN
 ...
 * - LV_STDLIB_CUSTOM:      Implement the functions externally
 */
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN//LV_STDLIB_CLIB//LV_STDLIB_BUILTIN
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (128 * 128)    /**< [bytes]*/
